...
# %%
# 保存模型需要代码，torch.save
save_path = '/nfs/s2/userhome/xuezhichao/workingdir/group_coding/match_classifier_fc1_80.pth'
...
plt.legend()
picname = '/nfs/s2/userhome/xuezhichao/workingdir/group_coding/match_classifier_fc1_80.png'
