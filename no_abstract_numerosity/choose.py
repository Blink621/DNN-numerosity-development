...
# %%
        ...
        if judge != 0:
            ...
            try:
                ...
                print(df['pn'].max())
    idfile = 'id80_' + filename[4:-4] + '.npy'
    np.save(idfile, idlist80)
    idfile = 'id85_' + filename[4:-4] + '.npy'
    np.save(idfile, idlist85)
    idfile = 'id90_' + filename[4:-4] + '.npy'
    np.save(idfile, idlist90)
    idfile = 'id95_' + filename[4:-4] + '.npy'
    np.save(idfile, idlist95)
